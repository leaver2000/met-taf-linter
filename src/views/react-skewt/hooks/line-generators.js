...
export function elrLineGenerator({ x, y, tangent }, base,) {
    return d3
        .line()
...
export function dalrLineGenerator({ x, y, tangent }, logP, base) {
    return d3
        .line()
        .curve(d3.curveLinear)
        .x(function (d, i) {
...
export function malrLineGenerator({ x, y, tangent }, { log, base, top }, increment, moving) {
    return d3
        .line()
        .curve(d3.curveLinear)
        .x(function (d, i) {
...
export function isohumeLineGenerator({ x, y, tangent }, { log, base }) {
    var mixingRatio;
    var temp;
    return d3
        .line()

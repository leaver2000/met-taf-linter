...
export function tempLineGenerator({ x, y, tan }, { base }) {
    return d3.line()//
        .curve(d3.curveLinear)
        .x(function (d, i) { return x(d.temp) + (y(base) - y(d.press)) / tan; })
        .y(function (d, i) { return y(d.press); })
}

export function dewptLineGenerator({ x, y, tan }, { base }) {
    return d3.line().curve(d3.curveLinear).x(function (d, i) { return x(d.dwpt) + (y(base) - y(d.press)) / tan; }).y(function (d, i) { return y(d.press); });
